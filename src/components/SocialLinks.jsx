...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/prashant-phor-128620261?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@prashant-phor4",
    icon: Instagram,
    url: "https://www.instagram.com/prashant_phor4?igsh=MzRlODBiNWFlZA==",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@prashant0004",
    icon: Github,
    url: "https://github.com/prashant0004",
    color: "#ffffff",
  ...
  },
  {
    ...
    icon: ({ className, ...props }) => (
     <svg width="24px" height="24px" viewBox="0 0 45 45" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="">
    <title>Tiktok</title>
